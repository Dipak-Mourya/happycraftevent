      ...
      <div className="relative z-10 max-w-2xl mx-auto w-full">
        ...
        <div className="mt-6 pt-6 border-t border-muted/30">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <Link href="/about" className="text-primary hover:text-primary/80 underline underline-offset-4">
              About Us
            </Link>
            <Link href="/gallery" className="text-primary hover:text-primary/80 underline underline-offset-4">
              Gallery
            </Link>
            <Link href="/contact" className="text-primary hover:text-primary/80 underline underline-offset-4">
              Contact
            </Link>
          </div>
        </div>
        ...
        <div className="mt-8 p-4 bg-primary/10 rounded-lg border border-primary/20">
          <p className="text-sm text-muted-foreground">
            🎉 While you're here, why not check out our amazing event portfolio? 
            We create unforgettable experiences that never get lost!
          </p>
        </div>
      </div>
    </main>
